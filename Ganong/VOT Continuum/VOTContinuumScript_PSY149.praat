...
##
## Original script by Matthew B. Winn
## Small changes for PSY 149 experiment by Ariel Goldberg (2/2017)
##
## Matthew B. Winn 
##
## Version 10
...
form Settings
	...
	comment Enter a name for your continuum (e.g., dash-tash)
	sentence right_basename dash-tash

endform


parentDir$ = "C:\Users\Matt\Desktop\Speech_Continua"
...
left_f0steps = 1
right_min_F0onset = 90
right_max_F0onset = 140
...
preselected_Burst_and_Aspiration = 1
extracontrol = 0
...
removeObject: "Sound vot_segment"
removeObject: "Sound lengthened_VOT"
removeObject: "Sound VOT_1"
removeObject: "Sound VOT_2"
removeObject: "Sound VOT_3"
removeObject: "Sound VOT_4"
removeObject: "Sound VOT_5"
removeObject: "Sound VOT_6"
removeObject: "Sound VOT_7"
removeObject: "Sound VOT_8"
removeObject: "Sound VOT_9"
## finished :)	
    ...
    for thisVOTStep from 1 to votsteps
       ...
       Extract pitch tier
    	   ...
    	   # concatenate aspration and vowel
			...
			thisVOTStepinMS$ = string$(((number(thisVOTStep$) - 1) * 10) + 5)
    	   # assign the name based on the formatted numbers
       	      Rename... 'basename$''votPrefix$''thisVOTStepinMS$'
